...
<html>
<body>
<p>Thank you for registering for the MIT Spring 2013 Open! This is confirmation that we have received your registration information. <br>Please note however that your registration is not complete until we have received your payment, either online or by check. Thank you! </p><hr align="left" width="60%"/><br>'.
printConfirmation($varName, $varRating, $varMember, $varMemberNumber, $varExpires, $varStreet, $varCity, $varState, $varZip, $varPhone, $varEmail, $varBirthdate, $varClub, $varEvents, $varStudent, $varMembershipFee).'
